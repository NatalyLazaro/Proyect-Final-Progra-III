...
{
    class SnakeColaCircular:SnakeBase
    {
        public bool MoverLaCulebrita(ColaCircular culebra, Point posiciónObjetivo,
    int longitudCulebra, Size screenSize)
        {
            ...
            // Quitar cola
            if (culebra.fin > longitudCulebra)
            {
        ...
        public Point MostrarComida(Size screenSize, ColaCircular culebra)
        {
