...
{
    class SnakeColaConLista:SnakeBase
    {
        public bool MoverLaCulebrita(ColaConLista culebra, Point posiciónObjetivo,
        ...
        public Point MostrarComida(Size screenSize, ColaConLista culebra)
        {
