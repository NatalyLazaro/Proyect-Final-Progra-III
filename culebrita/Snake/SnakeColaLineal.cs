...
{
    class SnakeColaLineal:SnakeBase
    {
        public bool MoverLaCulebrita(ColaLineal culebra, Point posiciónObjetivo,
       int longitudCulebra, Size screenSize)
        ...
        public Point MostrarComida(Size screenSize, ColaLineal culebra)
        {
